...
const team = [
  {
    ...
    desc: "I’m honored to introduce the Serve and Lead Society, which I proudly founded with a vision to empower UET Lahore students through growth, opportunity, and service. Our mission is to help students discover their potential, build careers, and create real impact through internships, welfare support, and educational experiences. I invite all new students to join us to serve with purpose, lead with passion, and move together toward success.",
    img: farooq,
    align: "left",
  },
  {
